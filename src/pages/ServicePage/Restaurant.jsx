  ...
  return (
    <div>
      ...
      <div className="space-y-10 max-sm:w-[80%] justify-center mx-auto">
        ...
        <div className="bg-white flex justify-center space-x-14 max-sm:space-x-0 max-sm:flex-col-reverse">
          <ul className="list-disc pl-5 text-[20px] font-normal leading-[50px] max-sm:text-[10px] max-sm:leading-4 mt-[20px]">
          ...
          <div className="mt-[50px]">
            <img
              ...
              alt=""
              className="w-[600px] max-sm:h-[300px] max-sm:w-[400px] object-cover"
            />
          </div>
        </div>

        {/* Second section - Image first, Text second */}
        <div className="bg-white flex justify-center space-x-14 max-sm:space-x-0 max-sm:flex-col">
          <div>
            <img
          ...
          <ul className="list-disc pl-5 text-[20px] font-normal leading-[50px] max-sm:text-[10px] max-sm:leading-4 mt-[20px]">
            <h2 className="font-bold">Bottle</h2>
            <li>
      ...
      <div className="bg-gray-100 mt-10 flex items-center justify-center h-[100px]  max-sm:h-[60px]">
