        ...
        <div className=" flex flex-col md:flex-row justify-between items-center">
          <div className="text-center md:w-3/4 md:text-left m-auto">
            ...
            <p className="text-center text-lg md:text-xl font-light leading-8 pt-5">
              ...
              beautiful, hidden gem with lots of plants and tranquility. It is
              the perfect getaway from the hustle & bustle of the city! We
              always have between 6 and 10 beers on tap that we brewed
              ourselves.
            </p>
          </div>
